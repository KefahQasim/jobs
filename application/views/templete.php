...
<div class="page-header navbar navbar-fixed-top">
	...
	<div class="page-header-inner ">
		...
		<div class="page-logo">
			<a href="">
				<img src="https://localhost/jobs/system/assets/layouts/layout/img/logoo.jpeg" alt="logo" class="logo-default" style="margin:0px; margin-right:-20px; height: 50px; width: 235px"/> </a>
