...
<head>
	...
	<link href="<?php echo base_url(); ?>/assets/global/fullcalendar/base.css" rel="stylesheet" type="text/css"/>
	<link href="<?php echo base_url(); ?>/assets/global/fullcalendar/css.css" rel="stylesheet" type="text/css"/>
	<!-- form wizared -->
	...
	<link href="<?php echo base_url(); ?>/assets/global/plugins/bootstrap-touchspin/bootstrap.touchspin.css" rel="stylesheet"
		  type="text/css"/>
	...
	<link href="<?php echo base_url(); ?>/assets/global/css/components-rtl.css" rel="stylesheet" id="style_components"
		  type="text/css"/>
	...
	<link href="<?php echo base_url(); ?>/assets/layouts/layout/css/themes/default-rtl.css" rel="stylesheet" type="text/css"
		  id="style_color"/>
	<link href="<?php echo base_url(); ?>/assets/layouts/layout/css/custom-rtl.min.css" rel="stylesheet" type="text/css"/>

	<link href="<?php echo base_url(); ?>/assets/my/myFont.css" rel='stylesheet' type='text/css'>
	<link href="<?php echo base_url(); ?>/assets/my/panel_.css" rel="stylesheet" type="text/css"/>
	<!-- sweet alert -->
	<link href="<?php echo base_url(); ?>/assets/pages/sweetalert/sweetalert.css" rel="stylesheet" type="text/css"/>

	<!-- END THEME LAYOUT STYLES -->
	<link rel="shortcut icon" href="favicon.ico"/>
	<!-- add  css toastr -->
	<link href="<?php echo base_url(); ?>/assets/pages/css/toastr.css" rel="stylesheet" type="text/css"/>
		...
		<div class="page-sidebar navbar-collapse collapse">
			...
			<ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true"
				...
				<li class="nav-item start  selected">
					<a href="<?php echo base_url()."index.php/jobs_c/job_name";?>" class="nav-link nav-toggle">
						<i class=""></i>
					...
					<ul class="sub-menu ">
						<li>
							<a href="<?php echo base_url()."index.php/jobs_c/job_name";?>">
								<i class="fa fa-home"></i>
								الحرف
							</a>
						</li>
				...
				<li class="nav-item start  selected">
					...
					<ul class="sub-menu ">
						<li>
							<a href="<?php echo base_url()."index.php/jobs_c/viewJobInfo";?>">
								<i class="fa fa-home"></i>
								عرض المكلفين
							</a>
						</li>
						<li>
							<a href="<?php echo base_url()."index.php/jobs_c/jobs_info";?>">
				...
				<li class="nav-item start  selected">
					<a href="" class="nav-link nav-toggle">
						<i class=""></i>
						<span class="title">طباعة فواتير</span>
						<span class="arrow"></span>
					</a>
					<ul class="sub-menu ">
						<li>
...
<div class="page-footer text-center">
	<div class="page-footer-inner text-center" > <?php echo date('Y'); ?> &copy;بلدية دير البلح
...
<script src="<?php echo base_url(); ?>/assets/global/fullcalendar/moment.min.js" type="text/javascript"></script>
<script src="<?php echo base_url(); ?>/assets/global/fullcalendar/fullcalendar.js" type="text/javascript"></script>

<script src="<?php echo base_url(); ?>/assets/global/fullcalendar/home.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>/assets/global/plugins/jquery-validation/js/jquery.validate.js"
...
<script src="<?php echo base_url(); ?>/assets/pages/scripts/components-bootstrap-touchspin.js" type="text/javascript"></script>
...
<script src="<?php echo base_url(); ?>/assets/my_JS/multi_sel.js" type="text/javascript"></script>
...
<!-- add js toastr -->
<script src="<?php echo base_url(); ?>/assets/pages/scripts/toastr.js" type="text/javascript"></script>
<!--sweet alert -->
<script src="<?php echo base_url(); ?>/assets/pages/sweetalert/sweetalert.min.js" type="text/javascript"></script>
