...
<html lang="en" dir="rtl">
    ...
    <head>
        ...
        <link href="http://localhost/jobs/system/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost/jobs/system/assets/global/plugins/simple-line-icons/simple-line-icons.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost/jobs/system/assets/global/plugins/bootstrap/css/bootstrap-rtl.min.css" rel="stylesheet" type="text/css" />
        <link href="http://localhost/jobs/system/assets/global/plugins/bootstrap-switch/css/bootstrap-switch-rtl.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="http://localhost/jobs/system/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL STYLES -->
        <link href="http://localhost/jobs/system/assets/global/css/components-rtl.min.css" rel="stylesheet" id="style_components" type="text/css" />
        <link href="http://localhost/jobs/system/assets/global/css/plugins-rtl.min.css" rel="stylesheet" type="text/css" />
        <!-- END THEME GLOBAL STYLES -->
        <!-- BEGIN PAGE LEVEL STYLES -->
        <link href="http://localhost/jobs/system/assets/pages/css/login-2-rtl.min.css" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="http://localhost/jobs/system/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="http://localhost/jobs/system/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        ...
        <script src="http://localhost/jobs/system/assets/pages/scripts/login.min.js" type="text/javascript"></script>
